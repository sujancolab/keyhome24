...
<div class="container" style="max-width: 800px; margin-top:50px; margin-bottom:50px;">
    ...
    <div class="card shadow-sm">
        ...
        <p>L’ensemble du contenu de ce site est protégé par le droit d’auteur selon la législation suisse. Toute reproduction ou utilisation non autorisée est interdite.</p>
    </div>
</div>
@endsection
