...
<p>Keyhome24 assumes no responsibility for the content posted by users and for transactions between the parties. Users are solely responsible for their actions on the platform.</p>

<h5 class="fw-bold mt-4">6. Applicable law and legal venue</h5>
<p>
These conditions are subject to Swiss law. Any dispute will be subject to the exclusive jurisdiction of the courts of the canton of Basel-Landschaft, subject to an appeal to the Federal Court.</p>
    </div>
</div>
@endsection
